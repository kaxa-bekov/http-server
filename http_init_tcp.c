...
int init_server(server_init_s* init_struct){
    ...
    print("Creating the server address struct...\n");
    ...
    print("Server address struct created succesfully.\n");
    print("Binding the server socekt fd to the server addresss struct...\n");
    ...
    print("Server socket fd was succesfully bound to server address struct.\n");
